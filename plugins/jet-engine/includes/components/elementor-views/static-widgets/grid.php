...
if ( ! class_exists( 'Elementor\Jet_Listing_Grid_Widget' ) ) {
	...
	class Jet_Listing_Grid_Widget extends \Jet_Listing_Dynamic_Widget {
		...
		public function should_remove_wrapper() {
			return ! $this->has_widget_inner_wrapper();
		}
					...
					array_merge(
						...
						array(
							'selectors' => array(
								...
								'{{WRAPPER}} > .jet-listing-grid > .jet-listing-grid__slider.swiper-lib' => '--swiper-slide-min-width: {{VALUE}}px;',
							),
						)
					)
				);
					...
					array_merge(
						...
						array(
							'selectors' => array(
								...
								'{{WRAPPER}} > .elementor-widget-container > .jet-listing-grid > .jet-listing-grid__slider.swiper-lib' => '--swiper-slide-min-width: {{VALUE}}px;',
							),
						)
					)
				);
			...
			if ( $this->should_remove_wrapper() ) {
				$this->add_responsive_control(
					...
					array(
						...
						'selectors' => array(
							':is( {{WRAPPER}} > .jet-listing-grid > .swiper-lib > .swiper-wrapper, {{WRAPPER}} > .jet-listing-grid > .jet-listing-grid__items, {{WRAPPER}} > .jet-listing-grid > .jet-listing-grid__slider > .jet-listing-grid__items > .slick-list > .slick-track, {{WRAPPER}} > .jet-listing-grid > .jet-listing-grid__scroll-slider > .jet-listing-grid__items ) > .jet-listing-grid__item' => 'padding-left: calc({{SIZE}}{{UNIT}} / 2); padding-right: calc({{SIZE}}{{UNIT}} / 2);',
				...
				$this->add_responsive_control(
					...
					array(
						...
						'size_units' => array( 'px', 'em', 'rem', 'custom' ),
						'selectors' => array(
							':is( {{WRAPPER}} > .elementor-widget-container > .jet-listing-grid > .swiper-lib > .swiper-wrapper, {{WRAPPER}} > .elementor-widget-container > .jet-listing-grid > .jet-listing-grid__items, {{WRAPPER}} > .elementor-widget-container > .jet-listing-grid > .jet-listing-grid__slider > .jet-listing-grid__items > .slick-list > .slick-track, {{WRAPPER}} > .elementor-widget-container > .jet-listing-grid > .jet-listing-grid__scroll-slider > .jet-listing-grid__items ) > .jet-listing-grid__item' => 'padding-left: calc({{SIZE}}{{UNIT}} / 2); padding-right: calc({{SIZE}}{{UNIT}} / 2);',
		...
		public function register_carousel_style_settings() {
			...
			$this->add_responsive_control(
				...
				array(
					...
					'selectors'  => array(
						'{{WRAPPER}} .jet-listing-grid__slider > .jet-listing-grid__items > .slick-list, {{WRAPPER}} .jet-listing-grid__slider.swiper-lib' => 'padding: 0 {{SIZE}}{{UNIT}} !important;',
					),
					'condition' => array(
						'center_mode' => 'true',
					),
			...
			$this->add_responsive_control(
				...
				array(
					...
					'selectors'  => array(
						...
						'{{WRAPPER}} .jet-engine-swiper-pagination-wrapper .swiper-pagination-bullet' => '--swiper-pagination-bullet-horizontal-gap: calc( {{SIZE}}{{UNIT}} / 2 );',
					),
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						...
						'{{WRAPPER}} .jet-engine-swiper-pagination-wrapper' => '--swiper-pagination-bullet-inactive-color: {{VALUE}};',
					),
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						...
						'{{WRAPPER}} .jet-engine-swiper-pagination-wrapper' => '--swiper-pagination-color-hover: {{SIZE}};',
					),
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'selectors' => array(
						...
						'{{WRAPPER}} .jet-engine-swiper-pagination-wrapper' => '--swiper-pagination-color: {{VALUE}};',
					),
				)
			);
