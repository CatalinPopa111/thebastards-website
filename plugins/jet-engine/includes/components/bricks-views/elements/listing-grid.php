...
class Listing_Grid extends Base {
	...
	public function set_controls() {
		...
		$css_scheme = [
			...
			'swiper'      => '.jet-listing-grid__slider.swiper-lib',
		...
		$this->register_jet_control(
			...
			array(
				...
				'css'      => [
					[
						'property' => '--swiper-slide-min-width',
		...
		$this->register_jet_control(
			...
			[
				...
				'css'      => [
					...
					[
						'property' => '--swiper-pagination-bullet-size',
						'selector' => '.jet-engine-swiper-pagination-wrapper .swiper-pagination-bullet',
					],
				],
				'required' => [ 'dots', '=', true ],
			]
		...
		$this->register_jet_control(
			...
			[
				...
				'css'      => [
					...
					[
						'property' => '--swiper-pagination-bullet-horizontal-gap',
						'selector' => '.jet-engine-swiper-pagination-wrapper .swiper-pagination-bullet',
						'value'    => 'calc( %s / 2 )',
					],
				],
		...
		$this->register_jet_control(
			...
			[
				...
				'css'      => [
					...
					[
						'property' => '--swiper-pagination-bullet-inactive-color',
						'selector' => '.jet-engine-swiper-pagination-wrapper .swiper-pagination-bullet',
					],
				],
				'required' => [ 'dots', '=', true ],
		...
		$this->register_jet_control(
			...
			[
				...
				'css'      => [
					...
					[
						'property' => '--swiper-pagination-color-hover',
						'selector' => '.jet-engine-swiper-pagination-wrapper .swiper-pagination-bullet',
					],
				],
				'required' => [ 'dots', '=', true ],
		...
		$this->register_jet_control(
			...
			[
				...
				'css'      => [
					...
					[
						'property' => 'border-color',
						'selector' => '.jet-engine-swiper-pagination-wrapper .swiper-pagination-bullet-active',
					],
				],
				'required' => [ 'dots', '=', true ],
			]
