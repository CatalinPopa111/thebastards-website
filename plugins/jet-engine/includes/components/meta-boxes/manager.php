...
if ( ! class_exists( 'Jet_Engine_Meta_Boxes' ) ) {
	...
	class Jet_Engine_Meta_Boxes extends Jet_Engine_Base_WP_Intance {
		...
		public function init_data() {
			...
			require_once $this->component_path( 'taxonomy-terms-helper.php' );
			require_once $this->component_path( 'taxonomy-values-helper.php' );
			require_once $this->component_path( 'taxonomy-field.php' );
			require_once $this->component_path( 'taxonomy-terms-sync.php' );

			new Jet_Engine_Meta_Boxes_Taxonomy_Field();
			new Jet_Engine_Meta_Boxes_Taxonomy_Terms_Sync();
