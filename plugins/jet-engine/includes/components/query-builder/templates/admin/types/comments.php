		...
		>
						...
						>
							...
							>
								...
								<cx-vui-input
									...
									description="<?php _e( 'Date to retrieve comments after. Eg. January 1st 2020, Today, Tomorrow etc.', 'jet-engine' ); ?>"
									:wrapper-css="[ 'equalwidth', 'has-macros' ]"
									size="fullwidth"
								...
								<cx-vui-input
									...
									description="<?php _e( 'Date to retrieve comments before. Eg. January 1st 2020, Today, Tomorrow etc.', 'jet-engine' ); ?>"
									:wrapper-css="[ 'equalwidth', 'has-macros' ]"
									size="fullwidth"
								...
								<cx-vui-select
									...
									description="<?php _e( 'Comments column to query against', 'jet-engine' ); ?>"
									:wrapper-css="[ 'equalwidth' ]"
									:options-list="[
										{
											value: 'comment_date',
			...
			>
				...
				<cx-vui-select
					...
					description="<?php _e( 'Field to order comments by', 'jet-engine' ); ?>"
					:wrapper-css="[ 'equalwidth' ]"
					:options-list="[
						{
							value: 'comment_agent',
