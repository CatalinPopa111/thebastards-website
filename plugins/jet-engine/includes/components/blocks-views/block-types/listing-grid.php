		...
		public function add_style_manager_options() {
			...
			$this->controls_manager->add_responsive_control(
				array(
					...
					'css_selector' => array(
						':is( {{WRAPPER}} > .jet-listing-grid > .swiper-lib > .jet-listing-grid__items, {{WRAPPER}} > .jet-listing-grid > .jet-listing-grid__items, {{WRAPPER}} > .jet-listing-grid > .jet-listing-grid__slider > .jet-listing-grid__items > .slick-list > .slick-track, {{WRAPPER}} > .jet-listing-grid > .jet-listing-grid__scroll-slider > .jet-listing-grid__items ) > .jet-listing-grid__item' => 'padding-left: calc({{VALUE}}{{UNIT}} / 2); padding-right: calc({{VALUE}}{{UNIT}} / 2);',
			...
			$this->controls_manager->add_control(
				array(
					...
					'css_selector' => array(
						'{{WRAPPER}} .jet-listing-grid__slider > .jet-listing-grid__items > .slick-list, {{WRAPPER}} .jet-listing-grid__slider.swiper-lib' => 'padding: 0 {{VALUE}}{{UNIT}} !important;',
					),
					'condition' => array(
						'center_mode' => true,
					),
			...
			$this->controls_manager->add_control(
				array(
					...
					'css_selector' => array(
						...
						'{{WRAPPER}} .jet-engine-swiper-pagination-wrapper' => '--swiper-pagination-bullet-size: {{VALUE}}px',
					),
				)
			);
			...
			$this->controls_manager->add_control(
				array(
					...
					'css_selector' => array(
						...
						'{{WRAPPER}} .jet-engine-swiper-pagination-wrapper' => '--swiper-pagination-bullet-horizontal-gap: calc( {{VALUE}}px/2 );',
					),
				)
			);
			...
			$this->controls_manager->add_control(
				array(
					...
					'css_selector' => array(
						...
						'{{WRAPPER}} .jet-engine-swiper-pagination-wrapper' => '--swiper-pagination-color-hover: {{VALUE}}',
					),
				)
			);
