...
if ( ! class_exists( 'Jet_Engine_Blocks_Views_Editor' ) ) {
	...
	class Jet_Engine_Blocks_Views_Editor {
		...
		public function __construct( $silent = false ) {
			...
			add_action( 'enqueue_block_editor_assets', array( $this, 'blocks_scripts' ), -1 );
			add_action( 'enqueue_block_assets', array( $this, 'blocks_styles' ), -1 );
		...
		public function blocks_styles() {
			do_action( 'jet-engine/blocks-views/editor-style/before' );
			...
			do_action( 'jet-engine/blocks-views/editor-style/after' );
		}
