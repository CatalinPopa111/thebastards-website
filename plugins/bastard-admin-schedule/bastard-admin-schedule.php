...
add_action( 'wp_enqueue_scripts', function () {
	...
	wp_register_style( 'bas-admin', BAS_URL . 'assets/admin-schedule.css', [ 'bas-google-fonts' ], '1.4.0' );
	// bas-admin se înregistrează fără dependință de Alpine (trebuie să se încarce primul)
	wp_register_script( 'bas-admin', BAS_URL . 'assets/admin-schedule.js', [], '1.4.0', true );
