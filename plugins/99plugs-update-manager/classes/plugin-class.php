...
class Plugs99_Plugin_Updater {
	...
	public function init() {
		...
		add_filter( 'pre_set_site_transient_update_plugins', array( $this, 'check_update' ), PHP_INT_MAX );
		add_filter( 'site_transient_update_plugins', array( $this, 'check_update' ), PHP_INT_MAX );
		add_filter( 'transient_update_plugins', array( $this, 'check_update' ), PHP_INT_MAX );
